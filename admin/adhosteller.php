             ...
             <div class="col-md-10 p-4">
                 ...
                 <div class="Hosteller">
                     <div class="d-flex justify-content-between align-items-center">
                         <h4>Total Hosteller</h4>
                         <button class="btn btn-primary" id="addNewHosteller">Add New Hosteller</button>
                     </div>
                     <!-- Search and Filters -->
                     <div class="d-flex justify-content-between align-items-center mt-3">
                         <input type="text" id="searchInput" class="form-control w-25" placeholder="Search Hosteller (Email, Name, Phone)">
